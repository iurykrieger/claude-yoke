...
last_synced_at: ""  # YYYY-MM-DD — last sync via /yoke:teach (optional)
...
# Yoke rippability (mandatory — never delete these on update)
ratified_at: ""                         # ISO 8601 date
model_calibrated_against: ""            # e.g., claude-opus-4-7
last_validated: ""                      # ISO 8601 date
traceability: ""                        # path to a failure or constraint that justified this entry
impact_level: ""                        # low | medium | high | regulatory

# Yoke graph relationships (for progressive disclosure)
depends_on: []
supersedes: []
applies_to: []
contradicts_with: []
