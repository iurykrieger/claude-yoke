...
runs:
  - {cycle: 1, started_at: "2026-04-27T22:41:09Z", status: fail, criterion: "FR-1", evidence_snippet: "bash: tests/canonical-memory/promoted-concept-frontmatter.test.sh: No such file or directory"}
  - {cycle: 2, started_at: "2026-04-27T22:52:17Z", status: fail, criterion: "FR-2", evidence_snippet: "bash: tests/canonical-memory/promoted-concept-frontmatter.test.sh: No such file or directory"}
  - {cycle: 3, started_at: "2026-04-27T23:02:33Z", status: pass, criterion: "FR-3", evidence_snippet: "✓ (0) helper writes concepts/<slug>.md to canonical-memory dir\\n✓ (FR-3) frontmatter field 'type' is non-empty (value: 'concept')\\n✓ (FR-3) frontmatter field 'name' is non-empty (value: 'redir…"}
---
