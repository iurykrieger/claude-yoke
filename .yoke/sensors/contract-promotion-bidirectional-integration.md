...
class: computational
tier: cheap
applies_to: [2026-04-27-sprint-contract-promotion-s01-t04]
runs:
  - {cycle: 1, started_at: "2026-04-27T22:41:09Z", status: fail, criterion: "FR-1", evidence_snippet: "bash: tests/canonical-memory/contract-promotion-bidirectional-integration.test.sh: No such file or directory"}
  - {cycle: 2, started_at: "2026-04-27T22:52:17Z", status: fail, criterion: "FR-2", evidence_snippet: "bash: tests/canonical-memory/contract-promotion-bidirectional-integration.test.sh: No such file or directory"}
  - {cycle: 3, started_at: "2026-04-27T23:02:33Z", status: fail, criterion: "FR-3", evidence_snippet: "bash: tests/canonical-memory/contract-promotion-bidirectional-integration.test.sh: No such file or directory"}
---
