...
runs:
  - {cycle: 1, started_at: "2026-04-27T22:41:09Z", status: fail, criterion: "FR-1", evidence_snippet: "bash: tests/canonical-memory/promoted-concept-slug-collision.test.sh: No such file or directory"}
  - {cycle: 2, started_at: "2026-04-27T22:52:17Z", status: fail, criterion: "FR-2", evidence_snippet: "bash: tests/canonical-memory/promoted-concept-slug-collision.test.sh: No such file or directory"}
  - {cycle: 3, started_at: "2026-04-27T23:02:33Z", status: pass, criterion: "FR-3", evidence_snippet: "✓ (FR-6) helper exited non-zero on slug-collision exhaustion (exit: 4)\\n✓ (FR-6) slug fn was invoked exactly 5 times (the documented retry cap)\\n✓ (FR-6) stderr diagnostic names the colliding …"}
---
