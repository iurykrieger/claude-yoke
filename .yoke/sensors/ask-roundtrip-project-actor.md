...
Legacy backing script (pre-realignment): `bash lib/sensors/yoke-ask-roundtrip.sh project actor`.
...
```json
{
  ...
  "sensor": "ask-roundtrip-project-actor",
  "status": "pass" | "fail",
