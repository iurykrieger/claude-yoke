...
token_cost: 0
time_cost: 30
command: bash lib/sensors/ack-sensors.sh --mode upsert --root tests/fixtures/sensors/upsert/ && diff -q tests/fixtures/sensors/upsert/sensors/existing-curated.md.snapshot tests/fixtures/sensors/upsert/sensors/existing-curated.md
---
