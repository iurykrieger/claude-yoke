...
token_cost: 0
time_cost: 30
command: bash -c '[ "$(grep -c "current_sprint: did not advance\|progress.md was split\|completed_sprints array does not equal" tests/smoke/ralph-loop-sprint-walk.test.sh | xargs)" -ge "3" ]'
---

# smoke-ralph-loop-sprint-walk-has-3-assertions
