...
runs:
  - {cycle: 1, started_at: "2026-04-27T22:41:09Z", status: fail, criterion: "FR-1", evidence_snippet: "bash: tests/canonical-memory/promoted-concept-actor-create.test.sh: No such file or directory"}
  - {cycle: 2, started_at: "2026-04-27T22:52:17Z", status: fail, criterion: "FR-2", evidence_snippet: "bash: tests/canonical-memory/promoted-concept-actor-create.test.sh: No such file or directory"}
  - {cycle: 3, started_at: "2026-04-27T23:02:33Z", status: pass, criterion: "FR-3", evidence_snippet: "✓ (FR-7) actor file created at /var/folders/q6/xwt3dd0s1w91t368slcwz_2w0000gq/T/tmp.RdJdwkhe2A/canonical-memory/actors/brand-new-actor.md\\n✓ (FR-7) frontmatter 'type' = 'actor'\\n✓ (FR-7) front…"}
---
