...
class: computational
tier: cheap
applies_to: [2026-04-27-sprint-contract-promotion-s01-t02]
runs:
  - {cycle: 1, started_at: "2026-04-27T22:41:09Z", status: fail, criterion: "FR-1", evidence_snippet: "bash: tests/canonical-memory/semantic-overlap-rewrite.test.sh: No such file or directory"}
  - {cycle: 2, started_at: "2026-04-27T22:52:17Z", status: pass, criterion: "FR-2", evidence_snippet: "✓ (1) cohesive case emits exactly one merged candidate with occurrences: 2\\n✓ (1*) cohesive merged candidate's reason references both originating contracts (Scenario 2 binding)\\n✓ (1**) cohesi…"}
  - {cycle: 3, started_at: "2026-04-27T23:02:33Z", status: pass, criterion: "FR-3", evidence_snippet: "✓ (1) cohesive case emits exactly one merged candidate with occurrences: 2\\n✓ (1*) cohesive merged candidate's reason references both originating contracts (Scenario 2 binding)\\n✓ (1**) cohesi…"}
---
