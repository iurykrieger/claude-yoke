...
> Source of truth for required fields: `templates/canonical/team/_template.md`
> Lineage: copied from bedrock 1.2.1 with kebab-case Yoke renames.

## What it is

A **team** is a squad with a defined organizational scope, identifiable members, and ownership over a set of actors. Teams are the organizational unit of the canonical memory — they represent the real squad structure of the organization.
...
- It is a reference to a non-technical team without system ownership (e.g., "legal compliance team", "HR team") — the canonical memory covers technology teams
...
2. "The HR team adjusted the meal voucher benefit." — Non-technical team without system ownership. Outside the canonical memory's scope.
