...
> Source of truth for required fields: `templates/canonical/project/_template.md`
> Lineage: copied from bedrock 1.2.1 with kebab-case Yoke renames.

## What it is

A **project** is an initiative with a closed scope, a deadline (real or estimated), concrete deliverables, and responsible focal points. Projects aggregate multiple actors, people, and topics under a common objective. They are the "hub" of an initiative in the canonical memory.
