...
> Source of truth for required fields: `templates/canonical/topic/_template.md`
> Lineage: copied from bedrock 1.2.1 with kebab-case Yoke renames.

## What it is

A **topic** is a cross-cutting subject with its own lifecycle (open → in-progress → completed/cancelled). Topics represent initiatives, incidents, RFCs, deprecations, or any theme that evolves over time and affects multiple actors or people. They are the "tracker" of subjects in the canonical memory.
