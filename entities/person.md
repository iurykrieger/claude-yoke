...
> Source of truth for required fields: `templates/canonical/person/_template.md`
> Lineage: copied from bedrock 1.2.1 with kebab-case Yoke renames.

## What it is

A **person** is any internal collaborator of the organization who is identifiable and relevant to the canonical memory's context — engineer, tech lead, manager, product manager, engineering manager, designer, DRI, or any other professional who participates in decisions, operations, or technical contributions.
...
Persons are connected to teams and actors via wikilinks. The canonical memory tracks people to understand: who works on what, who is the focal point for which system, who participated in which decisions, and what each person's role is in the organization.

## When to create

- The content mentions a person by full name AND it is possible to associate them with a team or actor in the memory
...
- The content mentions a professional (PM, EM, designer, etc.) who actively participates in a team or project in the memory, even without direct code contribution
...
- It is a person mentioned only once without team/actor context — probably not relevant to the memory
...
- Body: **append-only.** Never delete content written by another agent or human.
